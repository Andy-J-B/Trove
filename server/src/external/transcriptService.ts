...
export async function getTranscript(tiktokUrl: string): Promise<string> {
  ...
  //   id: "7267220752909225248",
  //   url: "https://vt.tiktok.com/ZSU4DLbcx/",
  //   transcript:
  //     "WEBVTT\n" +
  //     "\n" +
  //     "\n" +
  //     "00:00:00.200 --> 00:00:02.400\n" +
  //     "Uniqlo's pants that every man needs\n" +
  //     "\n" +
  //     "00:00:02.400 --> 00:00:05.360\n" +
  //     "these are the Uniqlo pleated trousers and believe me\n" +
  //     "\n" +
  //     "00:00:05.360 --> 00:00:06.640\n" +
  //     "they fit amazing\n" +
  //     "\n" +
  //     "00:00:06.640 --> 00:00:09.260\n" +
  //     "they come with two straws to size perfectly\n" +
  //     "\n" +
  //     "00:00:09.280 --> 00:00:11.620\n" +
  //     "and the pants fits true to size\n" +
  //     "\n" +
  //     "00:00:11.640 --> 00:00:13.612\n" +
  //     "drop your phone and run to Uniqlo\n",
  // };
